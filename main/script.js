...
function ingresoFormulario(e){
    e.preventDefault();
    let persona = new Persona (nombreInput.value, emailInput.value, telefonoInput.value)
    let consulta = new Consulta (nombreInput.value, telefonoInput.value, consultaInput.value)
